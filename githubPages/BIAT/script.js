...
const study = lab.util.fromObject({
  ...
  "metadata": {
    ...
    "repository": "",
    "contributors": "Masanori Kobayashi (Yamagata Univ.)"
  },
  "files": {},
  "responses": {},
  "content": [
                ...
                "items": [
                  {
                    ...
                    "type": "text",
                    "title": "ご参加ありがとうございます。",
                    "content": "本実験・調査の実施者は○○の○○です。実施責任者は○○の○○です。本実験・調査への参加はあなたの任意によるものです。"
                  },
                  {
                    "required": true,
                    "type": "text",
                    "title": "本実験・調査の目的",
                    "content": "単語の分類課題の成績を調べることが本実験・調査の目的です。"
                  },
                  {
                    "required": true,
                    "type": "text",
                    "title": "本実験・調査の手続き",
                    "content": "本実験・調査では単語を分類する課題を行って頂きます。この実験・調査の所要時間は5〜10分程度です。"
                  },
                  {
                    "required": true,
                    "type": "text",
                ...
                "items": [
                  {
                    "type": "text",
                    "title": "お疲れさまでした！",
                    "content": "最後に実験・調査に関する質問にご回答ください。どのような回答でもペナルティなどは”まったく”ありませんので，以下の質問には，正直にご回答ください。"
                  },
                  {
                    "required": true,
                    "type": "radio",
                  ...
                  },
                  {
                    ...
                    "type": "textarea",
                    "label": "問題の内容",
                    "help": "「実験・調査の実施に支障のある大きな問題が生じた」または「実験・調査の実施に支障のない程度の問題が生じた」とご回答くださった方は，その内容を以下の記入してください。",
                    "name": "problemContent"
                  },
                  {
                    "required": true,
                  ...
                  },
                  {
                    ...
                    "label": "過去に同一の内容の実験・調査に参加したことはありますか？",
              ...
              },
              {
                ...
                "items": [
                  ...
                  },
                  {
                    "required": true,
                    "type": "html",
                    "content": "\u003Cdiv class=\"content-horizontal-center\"\u003E\u003Cbutton\u003Eメモしたので，次へいく\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E",
                    "name": ""
                  }
                ],
                "scrollTop": true,
                "submitButtonText": "メモしたので，次へ",
                "submitButtonPosition": "hidden",
                "files": {},
                "responses": {},
                "parameters": {},
...
const block1Concept1FocalMeanRT = meanRTs(block1Concept1FocalRTs)

//2ブロックの概念1ブロックの平均反応時間
const block2Concept1FocalMeanRT = meanRTs(block2Concept1FocalRTs)
...
const block1Concept2FocalMeanRT = meanRTs(block1Concept2FocalRTs)

//2ブロックの概念2ブロックの平均反応時間
const block2Concept2FocalMeanRT = meanRTs(block2Concept2FocalRTs)
...
function pooledSD(RTs)
{
  ...
  for(i = 0; i < RTs.length; i++)
  {
    squredSum += (RTs[i] - mean)**2
  }
  var vars = squredSum/RTs.length
...
//1ブロックのSDを計算
const block1PooledSD = pooledSD(block1RTs);

//2ブロックのRT配列を作成
let block2RTs = block2Concept1FocalRTs.concat(block2Concept2FocalRTs)

//2ブロックのSDを計算
const block2PooledSD = pooledSD(block2RTs);
              ...
              },
              {
                ...
                "items": [
                  ...
                  },
                  {
                    "required": true,
                    "type": "html",
                    "content": "\u003Cdiv class=\"content-horizontal-center\"\u003E\u003Cbutton\u003E終了する\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E",
                    "name": ""
                  }
                ],
                "scrollTop": true,
